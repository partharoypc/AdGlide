package com.partharoypc.adglide.ui;
...
/**
 * Custom LinearLayout for displaying medium native ad templates with
 * customizable button backgrounds for AdMob and StartApp networks.
 */
public class MediumNativeAdView extends LinearLayout {
    ...
    private void initView() {
        inflate(mContext, R.layout.adglide_view_native_ad_medium, this);
